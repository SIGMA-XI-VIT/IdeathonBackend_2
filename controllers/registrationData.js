...
const testRoute = (async(req,res) => {
    return res.send(JSON.stringify({version: 0.1, prerelease: true}))
})

const postRegistration = (async(req,res) => {
    try
    {
        const {team_name, name1, name2, name3, name4, email, phoneno} = req.body
        const registration = new Registration({
            team_name, name1, name2, name3, name4, email, phoneno
        })
